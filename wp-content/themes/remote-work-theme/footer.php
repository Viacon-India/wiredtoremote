            ...
            <div class="footer-copyright-sec">
                <div class="container mx-auto ">
                    <div class="footer-copyright-sec-inner">
                        <p class="copyright">© <?php echo date('Y'); ?>. All rights reserved by <a class="copyright-a" href="https://www.redhatmedia.net/" rel="noopener noreferrer nofollow" target="_blank" aria-label="social_Link">Redhat Media.</a></p>
